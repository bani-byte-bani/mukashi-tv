...
- hits: [{"title": "曲名", "artist": "歌手名"}] … オリコン年間シングルランキング上位5曲（順位順）
- idols: {"female": [...], "male": [...]} … オリコン年間シングル売上上位に入ったアイドル（売上順・男女各3組）
- talents: {"female": [...], "male": [...]} … ビデオリサーチ「好きなタレント調査（テレビタレントイメージ調査）」の男女別上位
